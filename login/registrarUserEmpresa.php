...
<body class="bg-light" style="margin-left: 0px !important;">
  ...
  <?php if(isset($_SESSION['error_userEmpresa'])) : ?>
      <div class="alert alert-danger alert-dismissible fade show mx-auto mb-4 w-50" role="alert">
        Ocurrio un error al registrar al usuario para la empresa.
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  <?php
    unset($_SESSION['error_userEmpresa']);
    endif; 
  ?>
  <section id="cabeza" class="text-white font-weigth-bold">
    <div class="row m-0">
      ...
      <section class="form-login login_account_access">
        <center>
          <h5>Registro Usuario para empresa</h5>
        </center>
        <form action="validar-registroUserEmpresa.php" method="POST" name="login_account_access" id="login_account_access" class="row">
