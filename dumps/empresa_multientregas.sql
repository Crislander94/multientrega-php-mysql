...
(23, 'Jara', '12345', 'xxxxxxxx', '0943846464646', 'jara@gmail.com', '0888787878', 'PayPal', '2021-09-15 21:26:34', 'A');
...
(20, 4, 13, 1, 0, '2021-09-15 01:13:22', '2021-09-15 22:16:13', '45.00', '13.50', '27.00', '4.50', 'no me gusto', 'X', '2021-09-15 01:13:22', 13, NULL, NULL),
...
(22, 'Cristhian', 1, '50.00', 50, 0, 4, 'P', '2021-09-15 22:05:31', 3, NULL, NULL, NULL, NULL);
...
CREATE TABLE `resenia_clientes` (
  ...
  `estrellas` varchar(250) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `resenia_clientes`
--

INSERT INTO `resenia_clientes` (`id`, `cod_cliente`, `comentario`, `estrellas`, `created_at`) VALUES
(1, 13, '', '5', '2021-09-15 02:04:46'),
(2, 13, 'Me gusto el producto.', '5', '2021-09-15 21:20:52'),
...
--
ALTER TABLE `clientes`
  MODIFY `cod_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
